...
Category: Blog
Tags: brag document, smart goals, career
Authors: Christopher, Julia Evans
Summary: Make sure that you document your work to get recognized at work.
Status: draft
comment_id: get_your_work_recognized
...
For example, I like yo do this by making a section for areas that I have been
focused on (like "security") and listing all the work that I have done in that
area there.
...
The goal of this part is to pari up and review each other's documents and
identify places where people haven't bragged enough.

## Biweekly Brag Document Writing Sessiong
...
* Design docs: I usually just say "wrote design for X" or "reviewed design for
  X".
* Improving important processes, like th interview process or writing better
...
* About a specific area of programming (ex localization or timezones).
